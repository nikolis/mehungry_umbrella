defmodule MehungryWeb.UserIngredientRuleLive.FormComponent do
  ...
  def render(assigns) do
    ...
    <div>
      ...
      >
        ...
        <:actions>
          <.button phx-disable-with="Saving...">Save User ingredient rule</.button>
        </:actions>
      </.simple_form>
    </div>
    """
