defmodule MehungryWeb.CommentLive.Index do
  use MehungryWeb, :live_view

  import MehungryWeb.CoreComponents
  alias MehungryWeb.CoreComponents
  ...
  @impl true
  def handle_info({MehungryWeb.CommentLive.FormComponent, {:saved, comment}}, socket) do
