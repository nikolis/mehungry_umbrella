...
1. **Does NOT help "chemicals contained in a species."** PubTator3 extracts no
   ...
   (`docs/science/compound_measurements.md`, `docs/science/evidence_aggregation.md`).
...
2. **Persist** — new `study_entity_relations` table:
   ...
   resolver — see `docs/science/pubtator.md` for the chemical-resolution pattern to mirror).
