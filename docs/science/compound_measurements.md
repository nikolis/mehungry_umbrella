...
```
   ...
   Food.Compounds               ("Spinach contains Oxalate")   (docs/science/food_compounds.md)
        │
...
`IngredientCompoundRelationship` (`docs/science/food_compounds.md`) records **qualitative**
...
- **Aggregation layer.** Summarizing measurements per `(ingredient, compound)` —
  ...
  (see **`docs/science/evidence_aggregation.md`**); per-preparation rollups and unit
