...
Papers are discovered (`docs/literature_discovery.md`) and compounds carry chemical
identity (`docs/chemistry.md`), but there was no **entity layer**: the specific
...
- **Chemicals** route through `Mehungry.Chemistry.Resolver` (see `docs/chemistry.md`):
...
- No promotion of mentions into `IngredientCompoundRelationship` facts — the annotator
  ...
  `Food.CompoundCandidates` (**`docs/compound_candidates.md`**), which reads these mentions
